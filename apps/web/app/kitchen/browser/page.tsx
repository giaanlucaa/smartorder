    ...
    return (
      <main className="max-w-7xl mx-auto p-6">
        <div className="text-center py-12">
          ...
          <h1 className="text-xl font-semibold mb-2">Lade Bestellungen...</h1>
        </div>
      </main>
    );
  }
    ...
    <main className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">🍳 Browser Kitchen Display</h1>
            <p className="text-gray-600">
              Live-Ansicht aller offenen Bestellungen
            </p>
          </div>
