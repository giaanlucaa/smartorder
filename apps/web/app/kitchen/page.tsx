...
export default function KitchenPage() {
  ...
  const [filter, setFilter] = useState<'all' | 'open' | 'paid' | 'fulfilled'>('open');
  ...
  if (loading) {
    return (
      <AdminLayout title="Bestellungsverwaltung" subtitle="Lade Bestellungen..." showSidebar={false}>
  ...
  return (
    <AdminLayout title="Bestellungsverwaltung" subtitle="Service-Dashboard für Bestellungsverwaltung" showSidebar={false}>
      <div className="p-6">
        ...
        <div className="flex space-x-2">
          ...
          >
            Fertig ({orders.filter(o => o.status === 'FULFILLED').length})
          </button>
        </div>
      </div>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            {filter === 'all' 
              ...
              : `Keine Bestellungen mit Status "${getStatusText(filter.toUpperCase())}" vorhanden.`
            }
          </p>
        </div>
      ) : (
