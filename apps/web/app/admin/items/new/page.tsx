  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">Lade Formular...</div>
      </div>
    );
  }
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              {isEditing ? 'Menüartikel bearbeiten' : 'Neuer Menüartikel'}
            </h1>
            <p className="mt-2 text-gray-600">
              {isEditing ? 'Bearbeiten Sie den Artikel' : 'Erstellen Sie einen neuen Artikel für Ihr Menü'}
            </p>
          </div>
          <button
